              ...
              children: [
                ...
                if (widget.chapterMarkers.isNotEmpty)
                  for (int i = 0; i < widget.chapterMarkers.length; i++)
                    Positioned(
                      left: (widget.chapterMarkers[i].inMilliseconds /
                              widget.totalDuration.inMilliseconds) *
                ...
                // Completed progress
                Container(
                  width: _currentSliderPosition * MediaQuery.of(context).size.width,
                  height: 4,
                  decoration: BoxDecoration(
                    color: primaryColor,
                    borderRadius: BorderRadius.only(
                      ...
                      topRight: _currentSliderPosition == 1.0 ? Radius.circular(2) : Radius.zero,
                      bottomRight: _currentSliderPosition == 1.0 ? Radius.circular(2) : Radius.zero,
                    ),
                  ),
                ),
                ...
                // Seek handle
                Positioned(
                  left: _currentSliderPosition * MediaQuery.of(context).size.width,
                  child: Container(
                    width: 16,
                    height: 16,
                    decoration: BoxDecoration(
