...
class _LibraryScreenState extends State<LibraryScreen> {
  ...
  List<Audiobook> get _filteredAudiobooks {
    var filtered = _audiobooks.where((book) {
      final matchesSearch = _searchQuery.isEmpty ||
          book.title.toLowerCase().contains(_searchQuery.toLowerCase()) ||
          book.author.toLowerCase().contains(_searchQuery.toLowerCase());

      final matchesStatus = (book.completed && _showCompleted) ||
    ...
    switch (_sortBy) {
      ...
      default:
        filtered.sort((a, b) =>
            (b.lastPlayedAt ?? b.createdAt).compareTo(a.lastPlayedAt ?? a.createdAt));
        break;
    }
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return AudiobookCard(
                          ...
                          progress: audiobook.lastPlayedAt != null && audiobook.duration.inSeconds > 0
                              ? (DateTime.now().difference(audiobook.lastPlayedAt!).inSeconds / audiobook.duration.inSeconds).clamp(0.0, 1.0)
                              : null,
                          onTap: () {
...
final List<Audiobook> _mockAudiobooks = [
  ...
  Audiobook(
    ...
    album: 'Classic Literature',
    coverArtPath: null,
    duration: Duration(hours: 10, minutes: 33),
  ...
  Audiobook(
    ...
    coverArtPath: null,
    duration: Duration(hours: 8, minutes: 47),
