...
import '../../../domain/entities/audiobook.dart' as domain;
import '../../../domain/entities/playback_session.dart' as domain;
...
class AudiobookModel {
  ...
  factory AudiobookModel.fromDomain(domain.Audiobook audiobook) {
    return AudiobookModel(
      ...
      chapters: audiobook.chapters.map((c) => ChapterModel.fromDomain(c)).toList(),
...
class ChapterModel {
  ...
  int endTimeInMs;   // End time in milliseconds
...
class PlaybackSessionModel {
  ...
  int? sleepTimerDurationInMs; // Sleep timer duration in milliseconds
  ...
  domain.PlaybackSession toDomain() {
    return domain.PlaybackSession(
      ...
      sleepTimerDuration: sleepTimerDurationInMs != null ? Duration(milliseconds: sleepTimerDurationInMs!) : null,
    );
  }
...
class LibraryModel {
  ...
  DateTime lastScanAt;
  int totalAudiobooks;
  int totalDurationInMs; // Total duration in milliseconds
