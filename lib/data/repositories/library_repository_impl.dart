...
import '../repositories/audiobook_repository_impl.dart';
...
class LibraryRepositoryImpl implements LibraryRepository {
  ...
  Future<LibraryStats> getLibraryStats() async {
    try {
      ...
      final numInProgress = library.audiobooks.where((a) => !a.completed && a.lastPlayedAt != null).length;
      final numCompleted = library.audiobooks.where((a) => a.completed).length;
      final numNotStarted = library.audiobooks.where((a) => !a.completed && a.lastPlayedAt == null).length;
